...
export const authAPI = {
    ...
    login: (userId, password) => {
        return axiosInstance.post('/loginAction',
            new URLSearchParams({
                user_id: userId,
                password: password
            }),
     ...
     */
    signup: (userData) => {
        return axiosInstance.post('/request/join', userData);
    },
     ...
     */
    checkAuthentication: () => {
        return axiosInstance.get('/api/is-authenticated');
    },

    /**
     * Find user ID by mobile number
     * @param {string} mobile - Mobile number
     * @returns {Promise} Response with user ID
     */
    findId: (mobile) => {
        return axiosInstance.post('/request/findIdByMobile', {
    ...
    resetPassword: (mobile, newPassword) => {
        return axiosInstance.post('/request/resetPasswordByMobile', {
            mobile_number: mobile,
    ...
    verifyPhone: (mobile, code) => {
        return axiosInstance.post('/request/verification', {
            mobile_number: mobile,
